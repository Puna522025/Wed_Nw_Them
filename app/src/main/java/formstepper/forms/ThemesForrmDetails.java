...
public class ThemesForrmDetails extends Fragment implements View.OnClickListener {
    ...
    ImageView tickRed, tickBlue, tickBlack, tickGreen, tickcoupleback, tickPink, tickPinkPetals, tickNoImage, tickpatternOne, tickpatternTwo,
            tickPatternThree, pinkPetals, coupleback, patternOne, patternTwo, patternThree;

    RelativeLayout rlBackground;

    CardView rlPink, rlRed, rlGreen, rlBlack, rlBlue, rlImagePinkPetals, rlImageNoImage, rlCoupleMainBack,
            rlPatternOne, rlPatternTwo, rlPatternThree;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tickpatternOne = (ImageView) view.findViewById(R.id.tickpatternOne);
        tickpatternTwo = (ImageView) view.findViewById(R.id.tickpatternTwo);
        tickPatternThree = (ImageView) view.findViewById(R.id.tickpatternThree);

        pinkPetals = (ImageView) view.findViewById(R.id.pinkPetals);
        coupleback = (ImageView) view.findViewById(R.id.coupleback);
        patternOne = (ImageView) view.findViewById(R.id.patternOne);
        patternTwo = (ImageView) view.findViewById(R.id.patternTwo);
        patternThree = (ImageView) view.findViewById(R.id.patternThree);
        ...
        rlPatternOne = (CardView) view.findViewById(R.id.rlImagePatternOne);
        rlPatternTwo = (CardView) view.findViewById(R.id.rlImagePatternTwo);
        rlPatternThree = (CardView) view.findViewById(R.id.rlImagePatternThree);
        ...
        rlPatternTwo.setOnClickListener(this);
        rlPatternOne.setOnClickListener(this);
        rlPatternThree.setOnClickListener(this);
        ...
        Picasso.with(getActivity())
                .load(R.drawable.back_pattern_petals)
                .fit()
                .into(pinkPetals);
        //"2"
        Picasso.with(getActivity())
        ...
        //"3"
        Picasso.with(getActivity())
                .load(R.drawable.back_two_min)
                .fit()
                .into(patternOne);
        //"4"
        Picasso.with(getActivity())
                .load(R.drawable.pattern_three)
                .fit()
                .into(patternTwo);
        //"5"
        Picasso.with(getActivity())
                .load(R.drawable.pattern_six)
                .fit()
                .into(patternThree);
    }
        ...
        switch (view.getId()) {
          ...
          /*  case R.id.continueToInvite:
            ...
            case R.id.rlImageNoImage:
                ...
                tickpatternOne.setVisibility(View.GONE);
                tickpatternTwo.setVisibility(View.GONE);
                tickPatternThree.setVisibility(View.GONE);
                break;
            ...
            case R.id.rlImagePatternOne:
                backgroundSelected = "3";
                tickcoupleback.setVisibility(View.GONE);
                tickNoImage.setVisibility(View.GONE);
                tickPinkPetals.setVisibility(View.GONE);
                tickpatternOne.setVisibility(View.VISIBLE);
                tickpatternTwo.setVisibility(View.GONE);
                tickPatternThree.setVisibility(View.GONE);
                break;
            case R.id.rlImagePatternTwo:
                backgroundSelected = "4";
                tickpatternTwo.setVisibility(View.VISIBLE);
                tickcoupleback.setVisibility(View.GONE);
                tickNoImage.setVisibility(View.GONE);
                tickPinkPetals.setVisibility(View.GONE);
                tickpatternOne.setVisibility(View.GONE);
                tickPatternThree.setVisibility(View.GONE);
                break;
            case R.id.rlImagePatternThree:
                backgroundSelected = "5";
                tickPatternThree.setVisibility(View.VISIBLE);
                tickpatternTwo.setVisibility(View.GONE);
                tickcoupleback.setVisibility(View.GONE);
                tickNoImage.setVisibility(View.GONE);
                tickPinkPetals.setVisibility(View.GONE);
