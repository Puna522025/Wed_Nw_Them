...
public class Config {
    ...
    public static void setBackGroundInvite(String backImage, Activity activity, ImageView igBackground) {
        if (backImage.equalsIgnoreCase("1")) {
            //rlCouple.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.back_petals_blur));
            ...
            Picasso.with(activity)
                    ...
                    .fit()
                    .into(igBackground);
        } else if (backImage.equalsIgnoreCase("3")) {
            // rlCouple.setBackground(ContextCompat.getDrawable(getContext(),R.drawable.back_pattern_petals));
            Picasso.with(activity)
                    .load(R.drawable.back_two_min)
                    .fit()
                    .into(igBackground);
        } else if (backImage.equalsIgnoreCase("4")) {
            //rlCouple.setBackground(ContextCompat.getDrawable(getContext(),R.drawable.back_one_three_min));
            Picasso.with(activity)
                    .load(R.drawable.pattern_three)
                    .fit()
                    .into(igBackground);
        } else if (backImage.equalsIgnoreCase("5")) {
            Picasso.with(activity)
