...
//        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.back_pattern_petals);
//
...
//        view.setBackground(d);
        ...
        igBackground = (ImageView) view.findViewById(R.id.igBackground);
    ...
    /*    if(sharedPreferences.getString(Config.back_image,"0").equalsIgnoreCase("1")){
        ...
        Config.setBackGroundInvite(backImage, getActivity(),igBackground);
